	...
	return (
		<section>
			...
			<article className="flex flex-col justify-between items-start p-6 my-2 mx-2 bg-white bg-opacity-20 rounded-lg max-w-3xl">
				<iframe className="rounded-lg max-w-full md:w-full lg:w-full" src="https://open.spotify.com/embed/playlist/37i9dQZF1EM3B0EdB9SdQe" width="300" height="380" frameBorder="0" allowTransparency={true} allow="encrypted-media"></iframe>
			</article>
		</section>
	)
}
